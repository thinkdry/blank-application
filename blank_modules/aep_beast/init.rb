...
#ActionController::Base.send :include, ApplicationSbController
...
ActionView::Base.send :include, ApplicationSbHelper
ActionController::Base.send :include, ApplicationSbHelper
