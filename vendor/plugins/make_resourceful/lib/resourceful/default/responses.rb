      ...
      def self.included(base)
        base.made_resourceful do
          ...
          response_for(:show_fails) do |format|
            not_found = Proc.new { render :text => "Object introuvable", :status => 404 }
          ...
          response_for(:create) do |format|
            format.html do
              set_default_flash(:notice, "Création réussie !")
          ...
          response_for(:create_fails) do |format|
            format.html do
              set_default_flash :error, "Problème rencontré !"
          ...
          response_for(:update_fails) do |format|
            format.html do
              set_default_flash :error, "Problème rencontré durant l'enregistrement !"
          ...
          response_for(:destroy) do |format|
            format.html do
              set_default_flash :notice, "Object supprimé !"
          ...
          response_for(:destroy_fails) do |format|
            format.html do
              set_default_flash :error, "Problème rencontré durant la suppression !"
