class GoogleChart
  ...
  SIZE_VAR = 'chs'.freeze
  DATA_VAR = 'chd'.freeze
  LARGE_DATA_VAR = 'chds'.freeze
  LABELS_VAR = 'chl'.freeze
  COLORS_VAR = 'chco'.freeze
  BAR_WIDTH_SPACING_VAR = 'chbh'.freeze
  #Custom
  LABEL_AXIS_VAR = 'chxt'.freeze
  LABEL_AXIS_INDEX_VAR = 'chxl'.freeze
  LABEL_RANGE_VAR = 'chds'.freeze
  TYPE_VAR_VALUES = {
    :line => 'lc',
    :line_xy => 'lxy',
  ...
  attr_accessor :label_axis
  attr_accessor :label_axis_index
  attr_accessor :label_range
  ...
  def to_url
    ...
    params[LABEL_AXIS_VAR] = join(@label_axis) if @label_axis
    params[LABEL_AXIS_INDEX_VAR] = join(@label_axis_index) if @label_axis_index
    params[LABEL_RANGE_VAR] = join(@label_range) if @label_range
